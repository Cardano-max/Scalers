# Brand DNA — demo_studio (Fenmore Tattoo)

> Tenant: `demo_studio` · Display: "Fenmore Tattoo" · Type: multi-artist studio
...
> Fenmore Tattoo, its artists, its customers (`demo_studio` personas), addresses,
...
- **Who they are:** Fenmore Tattoo, an appointment-based custom studio in Denver, CO.
...
- "Fenmore Tattoo is an appointment-based custom tattoo studio in Denver, CO."
...
- **Person / POV:** the studio as "we" / "Fenmore", and name the specific resident
  artist ("Wren", "Elliot") — never a faceless corporate voice, never fake first-person as
...
- **Emoji policy:** 0–2 per caption, only 🌿 🖤 or ✒️; never hype emoji (🔥💯✨👑).  → vocabulary.emoji_policy
...
1. > You were three sessions into that half-sleeve with Elliot before life got busy — we
...
3. > Looking for real fine-line botanical? That's Wren's whole thing — delicate linework
...
4. > Healed work looking a little soft? Fenmore does free touch-ups within six months
...
1. **Hard near-miss (scarcity bleed — the identity line):**
   > 🔥 ONLY 2 SPOTS LEFT this week with Elliot! Book TODAY before they're gone — don't
   > miss out!!!
...
3. **Corporate / SaaS sludge:**
   > At Fenmore Tattoo, we leverage world-class artistry to deliver premium, bespoke
...
> file's artist roster (Elliot Prewitt, Wren Halloway, Rafi Sadeghi, Marlow Deitch, Gwen Lindqvist).*
